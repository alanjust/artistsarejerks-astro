/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=community-api/wrangler.jsonc community-api/worker-configuration.d.ts` (hash: c30ad30d8a991777b5d01a113d8af1fc)
// Runtime types generated with workerd@1.20260917.1 2026-09-17 nodejs_compat
interface __BaseEnv_Env {
	ARTWORK: R2Bucket;
	DB: D1Database;
	COMMUNITY_GATEWAY_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COMMUNITY_GATEWAY_SECRET">> {}
}
