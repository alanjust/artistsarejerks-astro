...
Default: **Ira Glass style** — read `agent_docs/voice-ira-glass.md` before writing any copy
Alternative: **Adam Moss style** (explicit request only) — read `agent_docs/voice-adam-moss.md`
Canonical reference for Ira Glass: "A Challenge to Institutional Authority" essay (260313)
