...
- Movements and Artists in History cards: thin black border and 12px corners like the rest of the site (drop shadows removed), movement colors unchanged. Card type warmed up: names and artist lists in Averia, descriptions regular weight instead of medium, the movement label on artist cards in small Averia capitals, and the text colors on tokens.
