...
export interface ArtistApplication {id:string;name:string;email:string;city:string;practice:string;portfolio:string;note:string;status:'pending'|'approved'|'declined';invitationAccepted:boolean;opportunities:boolean}
