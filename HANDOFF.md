...
- **Loose ends from that session:**
  ...
  - The Art History Wheel's new desktop layout and the Movements / Artists in History card changes haven't been seen on Alan's own screen.
...
5. Done: Movements and Artists in History keep their movement colors, now with the site's thin black card border, warmer Averia type, token text colors, and matching three-across grids.
