...
When observations are complete, close each Root section with one sentence beginning
"An artist working with this..." that names a specific visual mechanism the maker
could engage, resist, or test in their own work.
